...
import { PSSwapOutModalComponent } from './swap-out-modal.component';

describe('PSSwapOutModalComponent', () => {
  let component: PSSwapOutModalComponent;
  let fixture: ComponentFixture<PSSwapOutModalComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [PSSwapOutModalComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PSSwapOutModalComponent);
