...
export enum CLActions {
  RESET_CL_STORE = 'RESET_CL_STORE',
  UPDATE_API_CALL_STATUS_CL = 'UPDATE_API_CALL_STATUS_CL',
  SET_CHILD_NODE_SETTINGS_CL = 'SET_CHILD_NODE_SETTINGS_CL',
  FETCH_INFO_CL = 'FETCH_INFO_CL_CL',
  SET_INFO_CL = 'SET_INFO_CL',
  FETCH_FEES_CL = 'FETCH_FEES_CL',
  SET_FEES_CL = 'SET_FEES_CL',
  FETCH_FEE_RATES_CL = 'FETCH_FEE_RATES_CL',
  SET_FEE_RATES_CL = 'SET_FEE_RATES_CL',
  FETCH_BALANCE_CL = 'FETCH_BALANCE_CL',
  SET_BALANCE_CL = 'SET_BALANCE_CL',
  FETCH_LOCAL_REMOTE_BALANCE_CL = 'FETCH_LOCAL_REMOTE_BALANCE_CL',
  SET_LOCAL_REMOTE_BALANCE_CL = 'SET_LOCAL_REMOTE_BALANCE_CL',
  GET_NEW_ADDRESS_CL = 'GET_NEW_ADDRESS_CL',
  SET_NEW_ADDRESS_CL = 'SET_NEW_ADDRESS_CL',
  FETCH_UTXOS_CL = 'FETCH_UTXOS_CL',
  SET_UTXOS_CL = 'SET_UTXOS_CL',
  FETCH_PEERS_CL = 'FETCH_PEERS_CL',
  SET_PEERS_CL = 'SET_PEERS_CL',
  SAVE_NEW_PEER_CL = 'SAVE_NEW_PEER_CL',
  NEWLY_ADDED_PEER_CL = 'NEWLY_ADDED_PEER_CL',
  ADD_PEER_CL = 'ADD_PEER_CL',
  DETACH_PEER_CL = 'DETACH_PEER_CL',
  REMOVE_PEER_CL = 'REMOVE_PEER_CL',
  FETCH_CHANNELS_CL = 'FETCH_CHANNELS_CL',
  SET_CHANNELS_CL = 'SET_CHANNELS_CL',
  UPDATE_CHANNEL_CL = 'UPDATE_CHANNEL_CL',
  SAVE_NEW_CHANNEL_CL = 'SAVE_NEW_CHANNEL_CL',
  CLOSE_CHANNEL_CL = 'CLOSE_CHANNEL_CL',
  REMOVE_CHANNEL_CL = 'REMOVE_CHANNEL_CL',
  FETCH_PAYMENTS_CL = 'FETCH_PAYMENTS_CL',
  SET_PAYMENTS_CL = 'SET_PAYMENTS_CL',
  DECODE_PAYMENT_CL = 'DECODE_PAYMENT_CL',
  SET_DECODED_PAYMENT_CL = 'SET_DECODED_PAYMENT_CL',
  SEND_PAYMENT_CL = 'SEND_PAYMENT_CL',
  SEND_PAYMENT_STATUS_CL = 'SEND_PAYMENT_STATUS_CL',
  GET_QUERY_ROUTES_CL = 'GET_QUERY_ROUTES_CL',
  SET_QUERY_ROUTES_CL = 'SET_QUERY_ROUTES_CL',
  PEER_LOOKUP_CL = 'PEER_LOOKUP_CL',
  CHANNEL_LOOKUP_CL = 'CHANNEL_LOOKUP_CL',
  INVOICE_LOOKUP_CL = 'INVOICE_LOOKUP_CL',
  SET_LOOKUP_CL = 'SET_LOOKUP_CL',
  GET_FORWARDING_HISTORY_CL = 'GET_FORWARDING_HISTORY_CL',
  ...
  ADD_INVOICE_CL = 'ADD_INVOICE_CL',
  UPDATE_INVOICE_CL = 'UPDATE_INVOICE_CL',
