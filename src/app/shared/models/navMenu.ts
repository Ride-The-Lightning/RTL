...
export const MENU_DATA: MenuRootNode = {
  ...
  CLChildren: [
    ...
    {id: 3, parentId: 0, name: 'Lightning', iconType: 'FA', icon: faBolt, link: '/cl/peerschannels', userPersona: UserPersonaEnum.ALL, children: [
      ...
      {id: 36, parentId: 3, name: 'Sign/Verify', iconType: 'FA', icon: faUserCheck, link: '/cl/signverify', userPersona: UserPersonaEnum.ALL},
  ...
  ECLRChildren: [
    ...
    {id: 2, parentId: 0, name: 'On-chain', iconType: 'FA', icon: faLink, link:  '/eclr/onchain', userPersona: UserPersonaEnum.ALL},
    {id: 3, parentId: 0, name: 'Lightning', iconType: 'FA', icon: faBolt, link: '/eclr/peerschannels', userPersona: UserPersonaEnum.ALL, children: [
      {id: 31, parentId: 3, name: 'Peers/Channels', iconType: 'FA', icon: faUsers, link: '/eclr/peerschannels', userPersona: UserPersonaEnum.ALL},
      {id: 32, parentId: 3, name: 'Transactions', iconType: 'FA', icon: faExchangeAlt, link: '/eclr/transactions', userPersona: UserPersonaEnum.ALL},
      {id: 34, parentId: 3, name: 'Routing', iconType: 'FA', icon: faMapSigns, link: '/eclr/routing', userPersona: UserPersonaEnum.ALL},
      {id: 35, parentId: 3, name: 'Graph Lookup', iconType: 'FA', icon: faSearch, link: '/eclr/lookups', userPersona: UserPersonaEnum.ALL}
      ]},
    {id: 7, parentId: 0, name: 'Settings', iconType: 'FA', icon: faTools, link: '/settings', userPersona: UserPersonaEnum.ALL},
    {id: 8, parentId: 0, name: 'Help', iconType: 'FA', icon: faQuestion, link: '/help', userPersona: UserPersonaEnum.ALL}    
  ]
