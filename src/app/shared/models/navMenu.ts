import { faTachometerAlt, faLink, faBolt, faExchangeAlt, faUsers, faMapSigns, faQuestion, faSearch, faTools, faProjectDiagram, faDownload, faServer, faPercentage, faCircleNotch, faUserCheck } from '@fortawesome/free-solid-svg-icons';
...
export const MENU_DATA: MenuRootNode = {
  LNDChildren: [
    ...
    {id: 3, parentId: 0, name: 'Lightning', iconType: 'FA', icon: faBolt, link: '/lnd/peerschannels', userPersona: UserPersonaEnum.ALL, children: [
      ...
      {id: 36, parentId: 3, name: 'Loop', iconType: 'FA', icon: faCircleNotch, link: '/lnd/loop', userPersona: UserPersonaEnum.ALL},
