...
describe('LightningSendPaymentsComponent', () => {
  ...
  it('should send payment buttons work as expected', () => {
    ...
    sendButton.click();
    const expectedSendPaymentPayload = { uiMessage: UI_MESSAGES.SEND_PAYMENT, paymentReq: '', outgoingChannel: {}, feeLimitType: { id: 'none', name: 'No Fee Limit' }, feeLimit: null, fromDialog: true };
