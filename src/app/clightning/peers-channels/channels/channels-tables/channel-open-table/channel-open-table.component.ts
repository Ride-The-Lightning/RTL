...
export class CLChannelOpenTableComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private logger: LoggerService, private store: Store<RTLState>, private rtlEffects: RTLEffects, private clEffects: CLEffects, private commonService: CommonService, private route: ActivatedRoute) {
