  ...
  constructor(private logger: LoggerService, private store: Store<RTLState>, private actions: Actions, private commonService: CommonService, private router: Router) {
    ...
    if (this.screenSize === ScreenSizeEnum.XS) {
      this.operatorCards = [
        ...
        { id: 'status', goToOptions: ['Go To Channels', 'Go To Inactive Channels'], links: ['connections', 'connections/channels/pending'], icon: this.faNetworkWired, title: 'Channels', cols: 10, rows: 1 },
      ...
      this.operatorCards = [
        ...
        { id: 'status', goToOptions: ['Go To Channels', 'Go To Inactive Channels'], links: ['connections', 'connections/channels/pending'], icon: this.faNetworkWired, title: 'Channels', cols: 5, rows: 1 },
        { id: 'capacity', goToOptions: ['Go To Channels'], links: ['connections'], icon: this.faNetworkWired, title: 'Channels Capacity', cols: 10, rows: 2 }
      ];
      this.merchantCards = [
      ...
      this.operatorCards = [
        ...
        { id: 'status', goToOptions: ['Go To Channels', 'Go To Inactive Channels'], links: ['connections', 'connections/channels/pending'], icon: this.faNetworkWired, title: 'Channels', cols: 3, rows: 1 }
      ];
      this.merchantCards = [
