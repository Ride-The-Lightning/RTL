...
export const invoices = createSelector(eclState, (state: ECLState) => ({ invoices: state.invoices, totalInvoices: state.totalInvoices, apiCallStatus: state.apisCallStatus.FetchInvoices }));
