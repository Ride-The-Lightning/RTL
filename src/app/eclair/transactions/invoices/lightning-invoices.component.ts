...
export class ECLRLightningInvoicesComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    // this.store.dispatch(new ECLRActions.FetchInvoices({num_max_invoices: 100, index_offset: 0, reversed: false}));
  ...
  onDeleteExpiredInvoices() {
    ...
    .subscribe(confirmRes => {
      if (confirmRes) {
        ...
        // this.store.dispatch(new ECLRActions.DeleteExpiredInvoice());
      }
    });    
  }
