...
export const invoiceLookup = (req, res, next) => {
    ...
    if (paymentAddr === null) {
        return common.invalidQueryParam(res, 'payment_addr', 'a non-empty string');
    }
    if (paymentHash === null) {
        return common.invalidQueryParam(res, 'payment_hash', 'a non-empty string');
    }
    if (paymentAddr === undefined && paymentHash === undefined) {
        return common.invalidQueryParam(res, 'payment_addr or payment_hash', 'provided');
    }
