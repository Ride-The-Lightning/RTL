...
export class ConfigService {
    constructor() {
        ...
        this.normalizeSSL = (val) => {
            ...
            const { key = undefined, cert = undefined, ca = undefined, altIp = '127.0.0.1', certType = 'component', commonName = 'localhost', countryName = 'US', encryptionBits = 2048, stateName = 'New York', localityName = 'New York', organizationName = 'RTL', organizationalUnit = 'RTL', validForYears = 10, requestCert = false, rejectUnauthorized = false } = ssl;
            return {
                key,
                cert,
                ca,
