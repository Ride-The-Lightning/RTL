...
class CertificateFactory {
    ...
    constructor(opts = {}) {
        this.forge = forge;
        this.certBundle = null;
        this.encryptionBits = 2048;
        this.certType = 'component';
        this.validForYears = 10;
        this.commonName = 'localhost';
        this.organizationalUnit = 'RTL';
        this.organizationName = 'RTL';
        this.countryName = 'US';
        this.stateName = 'New York';
        this.localityName = 'New York';
        this.altName = 'https://localhost';
        this.altIp = '127.0.0.1';
        const { altIp = '127.0.0.1', certType = 'component', commonName = 'localhost', countryName = 'US', encryptionBits = '2048', stateName = 'New York', localityName = 'New York', organizationName = 'RTL', organizationalUnit = 'RTL', validForYears = '10' } = opts;
        assign(this, {
            certBundle: null,
            altName: `${commonName}`,
            altIp,
    ...
    //---------------------------------------------------------------------------------------
    getStaticBundle(type = 'string', password = null) {
        if (!this.certBundle) {
    ...
    //---------------------------------------------------------------------------------------
    _convertBundle(bundle, type, password) {
        const newBundle = {};
    ...
    //---------------------------------------------------------------------------------------
    _bundleToP12(bundle, password) {
        const { forge: { asn1, pki, pkcs12, util } } = this;
