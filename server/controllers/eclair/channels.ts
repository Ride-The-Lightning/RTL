...
export const simplifyAllChannels = (selNode: CommonSelectedNode, channels) => {
  ...
  channels.forEach((channel) => {
    ...
    simplifiedChannels.push({
      ...
      channelFlags:
        channel.data && channel.data.commitments && channel.data.commitments.channelFlags
      ...
      feeBaseMsat:
        channel.data && channel.data.channelUpdate && channel.data.channelUpdate.feeBaseMsat
      ...
      feeProportionalMillionths:
        channel.data && channel.data.channelUpdate && channel.data.channelUpdate.feeProportionalMillionths
